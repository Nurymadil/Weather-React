...
export default class WeatherCard extends Component {
  render() {
    ...
    return (
      ...
      //   </div>
      // </div>
      <div className="col-10 col-md-3 col-xl-2 card d-flex flex-column align-items-center align-content-md-between align-content-xl-between justify-content-center justify-content-md-between justify-content-xl-between">
